...
-- to run this file:
-- \i /Users/jaekim/projects/node/knex-practice/sql-scripts/seed.supplier.sql
...
-- What happens if we delete Blumfeld Paper?
DELETE FROM supplier WHERE id = 2;  SELECT * FROM supplier;  SELECT * FROM item;
